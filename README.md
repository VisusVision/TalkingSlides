...
- Existing short quickstart: [docs/LOCAL_DEVELOPMENT_QUICKSTART.md](docs/LOCAL_DEVELOPMENT_QUICKSTART.md)
- Repository smoke check: [docs/REPO_HEALTH_CHECK.md](docs/REPO_HEALTH_CHECK.md)
...
- Metrics and retry runbook: [docs/PROMETHEUS_AND_RETRY_RUNBOOK.md](docs/PROMETHEUS_AND_RETRY_RUNBOOK.md)

Developer-only planning docs live in:

- [docs/ROADMAP_TODO.md](docs/ROADMAP_TODO.md)
- [docs/TRADEOFFS_PLUS_MINUS.md](docs/TRADEOFFS_PLUS_MINUS.md)
- [docs/UNFINISHED_WORK.md](docs/UNFINISHED_WORK.md)
- [docs/avatar-production-roadmap.md](docs/avatar-production-roadmap.md)
