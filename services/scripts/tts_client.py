...
try:
    from tts_preprocess import clean_text_for_tts, prepare_effective_tts_input, prepare_text_for_tts
...
def _prepare_text_with_settings(text: str, lang: str, tts_settings: dict[str, Any] | None) -> dict[str, Any]:
    return prepare_effective_tts_input(text, language=lang, tts_settings=tts_settings)
