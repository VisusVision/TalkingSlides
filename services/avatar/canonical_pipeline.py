...
_PERSONAL_MOTION_STRENGTH_CAPS = {
    "calm": ("AVATAR_LIVEPORTRAIT_PERSONAL_MOTION_STRENGTH_CALM", 0.55),
    "natural": ("AVATAR_LIVEPORTRAIT_PERSONAL_MOTION_STRENGTH_NATURAL", 0.65),
    "expressive": ("AVATAR_LIVEPORTRAIT_PERSONAL_MOTION_STRENGTH_EXPRESSIVE", 0.80),
}
...
def render_avatar_segment_local_canonical(request: Any) -> dict[str, Any]:
    ...
    try:
        ...
        stage_paths["eye_blink_evidence_reliable"] = bool(final_validation.get("eye_blink_evidence_reliable"))
        stage_paths["eye_blink_evidence_warning"] = bool(final_validation.get("eye_blink_evidence_warning"))
        stage_paths["eye_blink_evidence_status"] = str(final_validation.get("eye_blink_evidence_status") or "not_reported")
        stage_paths["eye_landmark_coverage_ratio"] = float(final_validation.get("eye_landmark_coverage_ratio") or 0.0)
