...
const MOBILE_ITEMS = [
  { to: '/', labelKey: 'homeLabel', icon: LayoutDashboard, end: true },
  ...
  { to: '/analytics', labelKey: 'insightsLabel', icon: BarChart3, analyticsOnly: true },
  { to: '/moderation', labelKey: 'reviewLabel', icon: ShieldCheck, moderationOnly: true },
];
