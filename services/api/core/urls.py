...
urlpatterns = [
    ...
    path("me/analytics/intelligence/", CreatorAnalyticsIntelligenceView.as_view(), name="creator-analytics-intelligence"),
    path(
        "me/analytics/intelligence/analyze/",
        CreatorAnalyticsIntelligenceView.as_view(),
        name="creator-analytics-intelligence-analyze",
    ),
...
# Playback token issuance - no login required for published lessons
    ...
    path("projects/<int:project_id>/draft/promote/", ProjectDraftPromoteView.as_view(), name="project-draft-promote"),
    ...
    path("projects/<int:project_id>/partial-render-preview/", ProjectPartialRenderPreviewView.as_view(), name="project-partial-render-preview"),
